...
# weight: 1
# aliases: ["/first"]
tags: ["foundational-models", "generative-ai", "finetuning"]
categories: ["foundational-models"]
author: "Me"
showToc: true
TocOpen: false
draft: false
hidemeta: false
comments: false
summary: "Exploring controllable video generation with Wan-Vace and what I learned the hard way."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: true
...
![LoRA controllable video generation](og-image.jpg)
...
![Dynamic Prompt Generation](2-prompt-generation.jpg)
...
![Generated videos using LoRA](3-lora-results.jpg)
...
![Guidance scale for pretrained](exp-1-guidance.gif)

![Guidance scale for LoRA](exp-1-guidance-lora.gif)
...
![Inference sample steps](4-sample-steps.gif)

![Inference sample steps for LoRA](4-sample-steps-lora.gif)
...
![Prompt variations](5-prompt-variations.gif)
...
![LoRA alpha variations](6-lora-alpha.gif)
